...
@Mod.EventBusSubscriber(modid = EnhancedCelestialsTweaks.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public final class ForgeConfig {
    ...
    static final class GeneralSpec {
        ...
        final ForgeConfigSpec.BooleanValue logTweaks;
        final ForgeConfigSpec.BooleanValue eventsVisualOnly;
        final ForgeConfigSpec.BooleanValue recomputeForecastOnStart;

        GeneralSpec(ForgeConfigSpec.Builder b) {
    ...
    static final class DimensionSpec {
        final ForgeConfigSpec.EnumValue<BoolOverride> requireClearSkies;
        final ForgeConfigSpec.LongValue minDaysBetweenEvents;
        final ForgeConfigSpec.LongValue maxDaysBetweenEvents;
        final ForgeConfigSpec.LongValue dayLength;
        final ForgeConfigSpec.LongValue yearLengthInDays;

        DimensionSpec(ForgeConfigSpec.Builder b) {
    ...
    static final class EventSpec {
        ...
        final ForgeConfigSpec.EnumValue<BoolOverride> useBiomeSpawnSettings;
        final ForgeConfigSpec.EnumValue<BoolOverride> forceSurfaceSpawning;
        final ForgeConfigSpec.EnumValue<BoolOverride> slimesSpawnEverywhere;
        final ForgeConfigSpec.EnumValue<WeatherOverride> weatherOverride;
        final ForgeConfigSpec.BooleanValue restoreWeatherAfterEvent;
        final ForgeConfigSpec.ConfigValue<List<? extends String>> mobCategoryMultipliers;
        final ForgeConfigSpec.ConfigValue<List<? extends String>> spawnAdditions;
        final ForgeConfigSpec.ConfigValue<List<? extends String>> spawnRemovals;
        final ForgeConfigSpec.ConfigValue<List<? extends String>> addedDimensions;
        final ForgeConfigSpec.IntValue monsterSpawnLightLevel;
        final ForgeConfigSpec.DoubleValue mobGearChanceMultiplier;
        final ForgeConfigSpec.BooleanValue mobDropsEventGear;
        final ForgeConfigSpec.DoubleValue rareDropMultiplier;
        final ForgeConfigSpec.BooleanValue rareDropOnlyEventMobs;
        final ForgeConfigSpec.DoubleValue xpDropMultiplier;
        final ForgeConfigSpec.BooleanValue xpOnlyEventMobs;
        final ForgeConfigSpec.DoubleValue mobHealthMultiplier;
        final ForgeConfigSpec.DoubleValue mobDamageMultiplier;
        final ForgeConfigSpec.DoubleValue mobSpeedMultiplier;
        final ForgeConfigSpec.DoubleValue mobSwimSpeedMultiplier;
        final ForgeConfigSpec.BooleanValue preventMobDespawn;
        final ForgeConfigSpec.BooleanValue forceDespawnAfterEvent;
        final ForgeConfigSpec.IntValue forceDespawnDelaySeconds;
        final ForgeConfigSpec.ConfigValue<List<? extends String>> mobEffects;
        final ForgeConfigSpec.LongValue nightLengthTicks;
        final ForgeConfigSpec.ConfigValue<String> moonColor;
        final ForgeConfigSpec.ConfigValue<String> skyColor;
        final ForgeConfigSpec.ConfigValue<String> moonTexture;
        final ForgeConfigSpec.DoubleValue moonSizeMultiplier;
        final ForgeConfigSpec.ConfigValue<String> startMessage;
        final ForgeConfigSpec.ConfigValue<String> endMessage;
        final ForgeConfigSpec.BooleanValue enableCropDropBoost;
        final ForgeConfigSpec.ConfigValue<List<? extends String>> cropDropTags;

        EventSpec(ForgeConfigSpec.Builder b, ECTweaksConfig.EventDefaults defaults, String eventName) {
    ...
    static final class ClientGeneralSpec {
        final ForgeConfigSpec.ConfigValue<String> sleepPreventedMessage;

        ClientGeneralSpec(ForgeConfigSpec.Builder b) {
    ...
    static final class ClientEventSpec {
        final ForgeConfigSpec.ConfigValue<String> fogColor;
        final ForgeConfigSpec.DoubleValue fogDensityMultiplier;
        final ForgeConfigSpec.ConfigValue<String> soundtrack;
        final ForgeConfigSpec.DoubleValue soundtrackVolume;
        final ForgeConfigSpec.DoubleValue soundtrackPitch;
        final ForgeConfigSpec.BooleanValue soundtrackLoop;

        ClientEventSpec(ForgeConfigSpec.Builder b, ECTweaksConfig.EventDefaults defaults) {

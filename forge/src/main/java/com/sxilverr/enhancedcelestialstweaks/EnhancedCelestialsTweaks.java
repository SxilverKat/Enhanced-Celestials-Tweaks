...
public final class EnhancedCelestialsTweaks {
    ...
    public EnhancedCelestialsTweaks() {
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, ForgeConfig.SPEC, MOD_ID + "-common.toml");
        ModLoadingContext.get().registerConfig(ModConfig.Type.CLIENT, ForgeConfig.CLIENT_SPEC, MOD_ID + "-client.toml");
        MinecraftForge.EVENT_BUS.register(ECTweaksEvents.class);
    }
}
